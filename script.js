document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadProjectContent(project) {
        ...
        if (project === 'MyInfo') {
            windows = [
                { title: 'My Info', content: '<p>NOTE - Some browers take a while to load content, some windows have more content if you scroll on them, to view full sized images right click and press open image in new tab</p><p>Hi! My name is Harrison, I am 19 and currently a HNC Sound Production Student at Perth UHI. After this year I am hoping to be able to continue onto the degree and complete all 3 years. I have created this portfolio to demonstrate the work I have carried out over the past year while taking part in this course and to try to show how it has been relevant to a career as a studio engineer.</p><img src="images/Drumkit.png" height="200px">' },
